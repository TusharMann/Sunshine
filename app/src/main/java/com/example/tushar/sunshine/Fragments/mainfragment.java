...
public class mainfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] data = {
                ...
                "Friday     6/26 - Hot    38/21",
                "Saturday   6/27 - Sunny  30/22",
                "Sunday     6/28 - Rainy  21/12"
    };
        List<String>weekForcast=new ArrayList<>(Arrays.asList(data));

        ArrayAdapter<String >forecastAdapter=new ArrayAdapter<String>(getActivity(),R.layout.list_item_forecast,R.id.text1,data);
